...
rule run_DE_analysis:
    ...
    message: "\n\n######------ RUNNING DE ANALYSIS ------######\n"
    output:
        de = INPUTDIR + "diff_exp/DESeq2_gene/RSEM.gene.counts.matrix.A_vs_B.DESeq2.DE_results",
        de_mtx = INPUTDIR + "diff_exp/DESeq2_gene/RSEM.gene.counts.matrix.A_vs_B.DESeq2.count_matrix",
    singularity:
